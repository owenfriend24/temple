...
for run in runs:
        ...
        bolddata = bolddir+'/sub-%s_task-arrow_run-0%s_space-T1w_desc-preproc_bold_ss_4mm.nii.gz'%(sub,run)
        confoundfile = confounddir+'/sub-%s_task-arrow_run-0%s_formatted_confounds.txt'%(sub,run)

...
$ASHS_ROOT/bin/ashs_main.sh -I sub-${sub} -a $ASHS_ROOT/test_atlas/ -g $ASHS_ROOT/new_test/sub-${sub}/highres.nii.gz -f $ASHS_ROOT/new_test/sub-${sub}/coronal.nii.gz -w $ASHS_ROOT/new_test/sub-${sub}/

...
niter = 1000
phase,run,triad,item = loadtxt('/home1/09123/ofriend/analysis/temple/bin/templates/pre_post_ABC_items_drop6.txt',unpack=1)
...
for comparison in comparisons:
    ...
    for mask in masks:
        ...
        #similarity measure
        sl_func = temple_function_prepost_droprun('correlation',1,comparison,niter)

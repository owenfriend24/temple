...
niter = 1000
phase,run,triad,item = loadtxt(f'/home1/09123/ofriend/analysis/temple/bin/templates/pre_post_{comp}_items_drop{dropnum}.txt',unpack=1)
...
for comparison in comparisons:
    ...
    for mask in masks:
        ...
        subjoutfile_w = "%s_prepost_%s_%s_%s.txt"%(sbj, 'CB', 'within',mask)
        subjoutfile_a = "%s_prepost_%s_%s_%s.txt"%(sbj, 'CB', 'across',mask)

        os.makedirs(f'/corral-repl/utexas/prestonlab/temple/searchlight/prepost_CB_symm_txt/sub-{sbj}', exist_ok=True)
        os.chdir(f'/corral-repl/utexas/prestonlab/temple/searchlight/prepost_CB_symm_txt/sub-{sbj}')

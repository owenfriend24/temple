...
resultdir = expdir+'/searchlight/prepost_ABC'
sbj = sys.argv[1]
masktype = sys.argv[2]

ad = [19, 20, 22, 25, 37, 57, 59, 74, 72, 16, 24, 50, 56, 73, 71, 76, 58]
...
niter = 1000
phase,run,triad,item = loadtxt('/home1/09123/ofriend/analysis/temple/bin/templates/pre_post_ABC_items.txt',unpack=1)
...
for comparison in comparisons:
    ...
    for mask in masks:
        ...
        #elif masktype == 'b_hip':
         #   lmask = expdir+'/sub-%s/transforms/b_hip.nii.gz'%(sbj)
        elif masktype == 'sl':

...
def main(data_dir):
   ...
   # add IntendedFor field to fieldmaps
    for subject in layout.get_subjects():
        ...
        ref = df[df['participant_id'] == f'sub-{subject}']
        p_index = ref.index[0]

...
for run in 1 2 3 4; do
    ...
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/example_func.nii.gz" \
    ...
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/mask.nii.gz"\
    ...
    "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/reg/example_func2standard.mat"

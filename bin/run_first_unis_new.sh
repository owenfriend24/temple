...
for run in 1 2 3 4; do
    ...
    antsApplyTransforms -d 3 -i "${cope}" -o ${fmriprep_dir}/sub-${subject}/univ/"out_run${run}.feat"/stats/cope${track}.nii.gz -n BSpline -r /home1/09123/ofriend/analysis/temple/bin/templates/MNI152_T1_func_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"
    ((track=track+1))
    done
    ...
    fslreorient2std ${cope}
    antsApplyTransforms -d 3 -i "${cope}" -o ${fmriprep_dir}/sub-${subject}/univ/"out_run${run}.feat"/stats/varcope${track}.nii.gz -n BSpline -r /home1/09123/ofriend/analysis/temple/bin/templates/MNI152_T1_func_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"
    ((track=track+1))
    done
    ...
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/example_func.nii.gz"  -o "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/example_func.nii.gz" -n BSpline -r /home1/09123/ofriend/analysis/temple/bin/templates/MNI152_T1_func_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"
    
    fslreorient2std "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/mean_func.nii.gz"
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/mean_func.nii.gz" -o "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/mean_func.nii.gz" -n BSpline -r /home1/09123/ofriend/analysis/temple/bin/templates/MNI152_T1_func_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"


    # mask
    echo "transforming mask"
    fslreorient2std "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/mask.nii.gz"
    antsApplyTransforms -d 3 -i "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/native/mask.nii.gz" -o "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/mask.nii.gz" -n NearestNeighbor -r /home1/09123/ofriend/analysis/temple/bin/templates/MNI152_T1_func_brain.nii.gz -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Warp.nii.gz" -t "${fmriprep_dir}/sub-${subject}/transforms/native_to_MNI_Affine.txt" -t "${fmriprep_dir}/sub-${subject}/transforms/mask_to_func_ref_Affine.txt"
    
    echo "formatting reg folder"
    # set up reg folder
    mkdir "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/reg"
    cp /home1/09123/ofriend/analysis/temple/bin/templates/MNI152_T1_func_brain.nii.gz "${fmriprep_dir}/sub-${subject}/univ/out_run${run}.feat/reg/standard.nii.gz"

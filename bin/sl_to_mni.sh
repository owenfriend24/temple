...
mv ${fmriprep_dir}/integration_prepost/${measure}_${comp}/sub-${sub}/${sub}_${measure}_${comp}_${roi}_z.nii.gz ${fmriprep_dir}/integration_prepost/${measure}_${comp}/${roi}/sub-${sub}/${sub}_${measure}_${comp}_${roi}_z.nii.gz

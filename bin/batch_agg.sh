...
#  sl_to_mni.sh ${sub} ${CORR} ABC b_gray_func prepost
...
#sl_to_mni.sh temple023 /scratch/09123/ofriend/temple/new_prepo/derivatives/fmriprep/ ABC b_gray_func prepost
#temple_sl_prepost.py temple030 ABC gm --drop_run=6
#sl_to_mni.sh temple030 /scratch/09123/ofriend/temple/new_prepo/derivatives/fmriprep/ ABC b_gray_func prepost
#temple_sl_prepost.py temple070 ABC gm --drop_run=3
#sl_to_mni.sh temple070 /scratch/09123/ofriend/temple/new_prepo/derivatives/fmriprep/ ABC b_gray_func prepost
#temple_sl_prepost.py temple116 ABC gm --drop_run=5
#sl_to_mni.sh temple116 /scratch/09123/ofriend/temple/new_prepo/derivatives/fmriprep/ ABC b_gray_func prepost

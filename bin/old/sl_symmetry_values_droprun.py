...
from sl_symm_values_function_droprun import *
...
niter = 1000
phase,run,triad,item = loadtxt(f'/home1/09123/ofriend/analysis/temple/bin/templates/pre_post_{comp}_items_drop{dropped}.txt',unpack=1)
...
for comparison in comparisons:
    ...
    for mask in masks:
        ...
        #similarity measure
        sl_func = sl_symm_values_function_droprun('correlation',1,comparison,niter)

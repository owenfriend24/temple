...
resultdir = expdir+'/corral-repl/utexas/prestonlab/temple/'
sbj = sys.argv[1]
masktype = sys.argv[2]
comp = sys.argv[3]
...
for comparison in comparisons:
    ...
    for mask in masks:
       ...
       # results_a = across(ds)
        ...
        subjoutfile_w = "/scratch/09123/ofriend/temple/fix_76/%s_prepost_%s_%s_%s.txt"%(sbj, comp, 'within',mask)
        subjoutfile_a = "/scratch/09123/ofriend/temple/fix_76/%s_prepost_%s_%s_%s.txt"%(sbj, comp, 'across',mask)

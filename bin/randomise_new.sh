...
randomise -i ${fmriprep_dir}/integration_prepost/mni_${comp}/prepost/group_z.nii.gz \
-o ${fmriprep_dir}/integration_prepost/mni_${comp}/prepost/randomise_out/grouped_age_ \

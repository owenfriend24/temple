...
ten = []#[29, 51, 30, 33, 35, 60, 36, 32, 45, 38, 42]
...
niter = 1000
phase,run,triad,item = loadtxt('/home1/09123/ofriend/analysis/temple/bin/templates/pre_post_AC_items_drop6.txt',unpack=1)
...
for comparison in comparisons:
    ...
    for mask in masks:
        ...
        os.chdir("/scratch/09123/ofriend/temple/new_prepro/derivatives/fmriprep/searchlight/prepost_AC_txt")

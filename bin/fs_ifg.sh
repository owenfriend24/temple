...
mri_binarize --i $fs_input_dir/sub-$sub/mri/aparc+aseg.mgz --o $fs_output_dir/sub-${sub}/masks/ifg_masks/b_pars_orbitalis.nii.gz \
--match 1019 2019

mri_binarize --i $fs_input_dir/sub-$sub/mri/aparc+aseg.mgz --o $fs_output_dir/sub-${sub}/masks/ifg_masks/b_pars_triangularis.nii.gz \
--match 1020 2020

...
$ASHS_ROOT/bin/ashs_main.sh -I sub-${sub} -a $ASHS_ROOT/test_atlas/ -g $ASHS_ROOT/sub-${sub}/sub-${sub}_T1w_ss.nii.gz -f $ASHS_ROOT/sub-${sub}/sub-${sub}_desc-preproc_T2w.nii.gz -w $ASHS_ROOT/sub-${sub}/

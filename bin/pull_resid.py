...
def estimate_residuals(fs_dir, fm_dir, sub):
    for run in [1, 2, 3, 4, 5, 6]:
        ...
        func = (f'{fm_dir}/sub-{sub}/func/skullstripped_T1/sub-{sub}_task-arrow_run-0{run}_space-T1w_desc-preproc_bold_ss_4mm.nii.gz')
        ...
        nib.save(new_img, f'{fm_dir}/sub-{sub}/betaseries/sub-{sub}_run-{run}_resid.nii.gz')

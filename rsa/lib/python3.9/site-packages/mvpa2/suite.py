...
if externals.exists("pylab"):
    ...
    if externals.exists(["matplotlib", "griddata"]):
        from mvpa2.misc.plot.flat_surf import FlatSurfacePlotter, curvature_from_any
...
from mvpa2.misc.surfing import surf_voxel_selection, volgeom, volsurf, volume_mask_dict

...
class SuiteTest(unittest.TestCase):
    ...
    def test_docstrings(self):
        ...
        for c in (
            ("functions", "modules", "objects", "types") + ("classes",)
            ...
            for k, i in list(gs[c].items()):
                ...
                if hasattr(i, "__init__") and not c in ["objects"]:
                    ...
                    if si is None or si == "":
                        try:
                            ...
                            if (
                                i_file == inspect.getfile(i.__init__)
                                and "mvpa" in i_file
                            ):
                ...
                if si is not None and con_re1.search(si) and con_re2.search(si):

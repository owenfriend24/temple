...
class StateTests(unittest.TestCase):
    ...
    def test_proper_state(self):
        ...
        self.assertEqual(
            proper.ca.state2, 1000, msg="Simple assignment after being disabled"
        )
        ...
        self.assertEqual(set(proper.ca.keys()), {"state1", "state2"})
        ...
        self.assertTrue(set(proper2.ca.enabled) == {"state1"})
    ...
    def test_get_save_enabled(self):
        ...
        self.assertTrue(
            set(proper.ca.enabled) == {"state1", "state2"},
    ...
    def test_stored_temporarily(self):
        ...
        self.assertEqual(set(proper.ca.enabled), {"state1", "state2"})
        proper.ca.reset_changed_temporarily()
        self.assertEqual(proper.ca.enabled, ["state2"])

        # allow to enable disable without other instance
        proper.ca.change_temporarily(enable_ca=["state1", "state2"])
        self.assertEqual(set(proper.ca.enabled), {"state1", "state2"})
        proper.ca.reset_changed_temporarily()
        self.assertEqual(proper.ca.enabled, ["state2"])
    ...
    def test_proper_state_child(self):
        ...
        self.assertEqual(set(proper.ca.keys()), {"state1", "state2", "state4"})
    ...
    def test_parametrized(self):
        ...
        self.assertEqual(
            a.params.p1, 123, msg="We must have assigned value to instance"
        )
        self.assertTrue("state1" in a.ca.enabled, msg="state1 must have been enabled")
        ...
        try:
            ...
            self.fail(
                msg="Failed to generate an instance out of "

...
from mvpa2.testing.tools import assert_array_equal
...
class GPRTests(unittest.TestCase):
    ...
    def _test_gpr_model_selection(self):  # pragma: no cover
        ...
        dataset = datasets[
            "uni2small"
        ].copy()  # data_generators.linear1d_gaussian_noise()
        ...
        def prints():
            print((
                clf.ca.log_marginal_likelihood, clf.kernel.Sigma_p, clf.kernel.sigma_0
            ))

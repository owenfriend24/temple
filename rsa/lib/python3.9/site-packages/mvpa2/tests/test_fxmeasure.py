...
@sweepargs(ds=iter(list(tdatasets.values())))
...
_nonlin_tests = [
    (dataset_wizard([0, 1 - 0.01, 0, 1], targets=["a", "b", "a", "b"]), ([0.99], [1])),
    (
        dataset_wizard(
            [0, 1 - 0.01, 2, 0, 1, 2], targets=["a", "b", "c", "a", "b", "c"]
        ),
        ([0.99], [1]),
    ),
    # verify that order of 'labels' doesn't matter to get the same correspondence
    (dataset_wizard([1 - 0.01, 0, 1, 0], targets=["a", "b", "a", "b"]), ([0.99], [1])),
    ...
    (
        dataset_wizard(
            [0, 1 - 0.01, 2, 0, 1, 2], targets=["a", "c", "b", "a", "c", "b"]
        ),
        ([0.8], [1]),
    ),
    ...
    (
        dataset_wizard(
            [[0, 1], [1 - 0.01, 0], [0, 0], [1, 1]], targets=["a", "b", "a", "b"]
        ),
        ([0.99, -1e-10], [1.0 + 1e-10, 0.01]),
    ),
]

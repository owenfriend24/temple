...
from mvpa2.cmdline.helpers import parser_add_common_opt
...
def setup_parser(parser):
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="""In case of multi sample dataset,
...
def run(args):
    ...
    t, p = ttest_1samp(
        data, popmean=args.chance_level, axis=0, alternative=args.alternative
    )
    ...
    if s.shape != out_of_mask.shape:
        try:
            ...
            raise ValueError(
                "Cannot use mask of shape {0} with "

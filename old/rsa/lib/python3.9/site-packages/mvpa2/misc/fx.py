...
def dual_positive_gaussian(
    x, amp1=1.0, mean1=0.0, std1=1.0, amp2=1.0, mean2=0.0, std2=1.0
):
...
def fit2histogram(X, fx, params, nbins=20, x_range=None):
    ...
    for obsrv in X:
        ...
        if bin_centers is None:
            ...
            bin_width = np.abs(
                np.asscalar(np.unique(np.round(bin_left - hi[1][1:], decimals=6)))
            )
    ...
    return H, bin_left, bin_width, least_sq_fit(fx, params, H, bin_centers)

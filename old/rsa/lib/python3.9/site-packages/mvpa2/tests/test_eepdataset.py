...
from mvpa2.testing.tools import assert_equal, assert_true, assert_array_almost_equal
...
def test_eep_load():
    ...
    ds = [
        ...
        for source in (eb, pathjoin(pymvpa_dataroot, "eep.bin"))
    ]
    ...
    for d in ds:
        ...
        assert_array_almost_equal(
            [np.arange(-0.002, 0.005, 0.002)] * 32, d.a.mapper.reverse1(d.fa.timepoints)
        )

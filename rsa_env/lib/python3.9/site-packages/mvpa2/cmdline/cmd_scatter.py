...
scatterplot_opts_grp = (
    "options for scatterplot",
    [
        (("data",), dict(nargs="+", help="Nifti datasets to scatterplot")),
        (
            ("--volume", "-t"),
            dict(
                type=int,
        ...
        (
            ("-s", "--stats"),
            dict(default=False, help="Whether to print additional stats on the data"),
        ),
        (("-o", "--output-img"), dict(help="Where to output png of the scatterplot.")),
    ],
)

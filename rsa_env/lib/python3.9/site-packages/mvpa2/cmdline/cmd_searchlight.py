    ...
    for resblock in results:
        for res in resblock:
            if resmap is None:
                ...
                resmap = np.zeros(
                    (len(res), dataset.nfeatures), dtype=res.samples.dtype
                )
...
def setup_parser(parser):
    ...
    parser_add_optgroup_from_def(parser, crossvalidation_opts_grp, prefix="--cv-")

...
def matshow(matrix, xlabel_attr=None, ylabel_attr=None, numbers=None, **kwargs):
    ...
    **kwargs
    ...
    if numbers is not None:
        if isinstance(numbers, str):
            ...
            raise TypeError(
                "The argument to keyword 'numbers' must be "
        ...
        for i, cas in enumerate(matrix):
            for j, v in enumerate(cas):
                ...
                if numbers_alpha is None:
                    ...
                    alpha = 1 - np.array(1 - float(v) / maxv) ** numbers_alpha
                pl.text(j, i, numbers_format % v, alpha=alpha, **numbers_kwargs_)

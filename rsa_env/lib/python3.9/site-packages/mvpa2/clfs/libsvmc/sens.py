...
class LinearSVMWeights(Sensitivity):
    ...
    def _call(self, dataset, callables=None):
        ...
        if __debug__ and "SVM" in debug.active:
            ...
            debug(
                "SVM",
                "Extracting weights for %s: #SVs=%s, " % (svm_type, nsvs)

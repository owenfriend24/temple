...
# this location
pymvpa_dataroot = cfg.get(
    "data", "root", default=pathjoin(os.path.dirname(__file__), "data")
)
# locate PyMVPA data database root -- also might not be installed, but if it is,
# it should be at this location
pymvpa_datadbroot = cfg.get("datadb", "root", default=pathjoin(os.getcwd(), "datadb"))

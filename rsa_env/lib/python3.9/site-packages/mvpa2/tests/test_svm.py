...
class SVMTests(unittest.TestCase):
    ...
    def test_sillyness(self):
        ...
        if externals.exists("shogun"):
            ...
            self.assertRaises(TypeError, sg.SVM, C=10, kernel_type="RBF", coef0=3)
    ...
    def test_memleak(self):
        ...
        ds = mvpa2.clfs.base.Dataset.from_wizard(
            samples=np.arange(400000).reshape([4, 100000]), targets=np.arange(4)
        )
        ...
        self.assertTrue(
            mem0[1] + 100 >= mem1[1],
            msg="Memory consumption was %d, became %d" % (mem0[1], mem1[1]),
        )

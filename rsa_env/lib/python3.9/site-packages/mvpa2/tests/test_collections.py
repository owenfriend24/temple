...
def test_conditional_attr():
    ...
    for node in (
        ...
        assert_array_equal(
            node.ca["stats"].value.matrix, dc_node.ca["stats"].value.matrix
        )
        ...
        assert_array_equal(
            up_node.ca["stats"].value.matrix, node.ca["stats"].value.matrix
        )

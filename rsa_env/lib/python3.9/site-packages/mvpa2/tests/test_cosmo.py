...
def _create_small_mat_dataset_dict():
    ...
    sa = _tup2obj(
        [
            ("chunks", arr([[2], [2]])),
            ("targets", arr([[1], [2]])),
            ("labels", arr([arr(["yin"], dtype="O"), arr(["yan"], dtype="O")])),
        ]
    )
    fa = _tup2obj([("i", arr([[3.0, 2.0, 1.0]])), ("j", arr([[1.0, 2.0, 2.0]]))])
    a = _tup2obj(
        [("name", arr(arr(["input"], dtype="O"))), ("size", arr([[3.0], [2.0], [1.0]]))]
    )
...
def _create_small_mat_nbrhood_dict():
    ...
    fa = _tup2obj([("k", arr([[4.0, 3.0, 2.0, 1.0]]))])
...
def test_cosmo_searchlight():
    ...
    sl = cosmo.CosmoSearchlight(mean_feature(), _create_small_mat_nbrhood_dict())

    ds_count = sl(ds)
    dict_count = Dataset(
        samples=ds_count.samples,
